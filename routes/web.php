...
// Audiences
Route::get('audiences')->name('audiences')->uses('AudiencesController@index')->middleware('remember', 'auth');
Route::get('audiences/create')->name('audiences.create')->uses('AudiencesController@create')->middleware('auth');
Route::post('audiences')->name('audiences.store')->uses('AudiencesController@store')->middleware('auth');
Route::get('audiences/{contact}/edit')->name('audiences.edit')->uses('AudiencesController@edit')->middleware('auth');
Route::put('audiences/{contact}')->name('audiences.update')->uses('AudiencesController@update')->middleware('auth');
Route::delete('audiences/{contact}')->name('audiences.destroy')->uses('AudiencesController@destroy')->middleware('auth');
Route::put('audiences/{contact}/restore')->name('audiences.restore')->uses('AudiencesController@restore')->middleware('auth');

Route::get('audiences/import')->name('audiences.import')->uses('AudiencesController@import')->middleware('auth');
Route::post('audiences/import')->name('audiences.import')->uses('AudiencesController@runImport');
