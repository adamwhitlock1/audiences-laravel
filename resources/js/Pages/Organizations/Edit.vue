<template>
  <layout :title="form.name">
    <h1 class="mb-8 font-bold text-3xl">
      <inertia-link class="text-indigo-500 hover:text-indigo-800" :href="route('organizations')">Organizations</inertia-link>
    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-lg">
      <form @submit.prevent="submit">
        ...
        <div class="px-8 py-4 bg-gray-lightest border-t border-grey-lighter flex items-center">
    ...
    <div class="mt-6 bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="contact in organization.contacts" :key="contact.id" class="hover:bg-gray-lightest focus-within:bg-gray-lightest">
          <td class="border-t">
